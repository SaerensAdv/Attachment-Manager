...
function Router(){return <Switch><Route path="/" component={WorkspaceGraph}/><Route path="/graph"><Redirect to="/"/></Route><Route path="/atlas"><Redirect to="/"/></Route><Route path="/legacy"><Redirect to="/"/></Route><Route path="/generate"><Redirect to="/"/></Route><Route path="/dashboard" component={SystemHealth}/><Route path="/health"><Redirect to="/dashboard"/></Route><Route path="/team" component={AtlasAgents}/><Route path="/agents"><Redirect to="/team"/></Route><Route path="/clients/crawl" component={CrawlTool}/><Route path="/clients/search-terms" component={SearchTermsTool}/><Route path="/clients" component={AtlasClients}/><Route path="/crawl"><Redirect to="/clients/crawl"/></Route><Route path="/zoektermen"><Redirect to="/clients/search-terms"/></Route><Route path="/history" component={RunsHub}/><Route path="/runs"><Redirect to="/history"/></Route><Route path="/visuals"><Redirect to="/history"/></Route><Route path="/todo/schedules" component={OperationsSchedules}/><Route path="/todo" component={Operations}/><Route path="/operations"><Redirect to="/todo"/></Route><Route path="/planning"><Redirect to="/todo/schedules"/></Route><Route path="/controle" component={Knowledge}/><Route path="/knowledge"><Redirect to="/controle"/></Route><Route component={NotFound}/></Switch>}
