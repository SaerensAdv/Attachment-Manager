...
export default function AuthGate({ children }: { children: ReactNode }) {
  ...
  if (isLoading) return <div className="atlas-auth"><AtlasThemeToggle className="atlas-auth-theme" /><div className="atlas-auth-loader"><span>SA</span><i /><p>Opening Workspace Atlas</p></div></div>;
  if (!isAuthenticated) return <div className="atlas-auth">
    <AtlasThemeToggle className="atlas-auth-theme" />
    <div className="atlas-auth-brand"><span className="atlas-auth-mark">SA</span><p>Saerens Advertising</p></div>
