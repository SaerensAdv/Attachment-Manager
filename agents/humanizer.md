...
- **Cultural fit note:** Lore keeps every claim honest; she rewrites tone, never truth, and follows `knowledge/tone-of-voice.md`.
...
- Hold the result to `knowledge/tone-of-voice.md` (confident, transparent, honest, no overpromising) and `knowledge/agency-principles.md`.
...
- The Saerens voice (`knowledge/tone-of-voice.md`) and the client's tone from `clients/`, if a client applies
...
Follow `knowledge/tone-of-voice.md`. At minimum:
...
> This agent is primarily a voice-and-rhythm edit: its quality bar lives in `knowledge/tone-of-voice.md`, not in a generative skill.
