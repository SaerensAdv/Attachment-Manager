...
function Router() { return <Switch><Route path="/" component={WorkspaceGraph} /><Route path="/graph"><Redirect to="/" /></Route><Route path="/atlas"><Redirect to="/" /></Route><Route path="/legacy" component={Home} /><Route path="/generate"><Redirect to="/" /></Route><Route path="/dashboard" component={SystemHealth} /><Route path="/health"><Redirect to="/dashboard" /></Route><Route path="/team" component={Team} /><Route path="/clients" component={Clients} /><Route path="/crawl" component={CrawlUpload} /><Route path="/zoektermen" component={Zoektermen} /><Route path="/history" component={Runs} /><Route path="/runs"><Redirect to="/history" /></Route><Route path="/todo" component={Operations} /><Route path="/operations"><Redirect to="/todo" /></Route><Route path="/planning" component={Planning} /><Route path="/controle" component={Knowledge} /><Route path="/knowledge"><Redirect to="/controle" /></Route><Route path="/visuals" component={VisualStudio} /><Route component={NotFound} /></Switch>; }
const atlasRoutes = new Set(["/", "/graph", "/atlas", "/generate", "/todo", "/operations", "/history", "/runs", "/dashboard", "/health", "/controle", "/knowledge"]);
