    ...
    <div className="w-screen h-screen overflow-hidden relative bg-bg text-text font-body">
      ...
      <div className="absolute top-[7vh] left-[6vw] right-[6vw]">
        ...
        <h2 className="font-display font-extrabold text-[3.3vw] leading-[1.06] tracking-tight max-w-[72vw] text-balance">
          CarPlay-termen zonder conversies slokken budget op
        </h2>
      </div>
      ...
      <div className="absolute top-[31vh] left-[6vw] w-[44vw]">
        ...
        <div className="grid grid-cols-[2.6fr_1fr_1fr] items-center py-[1.55vh] border-b border-[#e4e2ee] text-[1.45vw]">
          <span>carplay installeren auto</span>
          <span className="text-right font-semibold">€34,88</span>
          <span className="text-right text-[#c0392b] font-semibold">0</span>
        </div>
        <div className="grid grid-cols-[2.6fr_1fr_1fr] items-center py-[1.55vh] border-b border-[#e4e2ee] text-[1.45vw]">
          <span>carplay installatie</span>
          <span className="text-right font-semibold">€13,85</span>
          <span className="text-right text-[#c0392b] font-semibold">0</span>
        </div>
        <div className="grid grid-cols-[2.6fr_1fr_1fr] items-center py-[1.55vh] border-b border-[#e4e2ee] text-[1.45vw]">
          <span>carplay laten installeren</span>
          <span className="text-right font-semibold">€11,08</span>
          <span className="text-right text-[#c0392b] font-semibold">0</span>
        </div>
        <div className="grid grid-cols-[2.6fr_1fr_1fr] items-center py-[1.55vh] border-b border-[#e4e2ee] text-[1.45vw]">
          <span>apple carplay laten inbouwen</span>
          <span className="text-right font-semibold">€10,95</span>
          <span className="text-right text-[#c0392b] font-semibold">0</span>
        </div>
        <div className="grid grid-cols-[2.6fr_1fr_1fr] items-center py-[1.55vh] border-b border-[#e4e2ee] text-[1.45vw]">
          <span>carplay android inbouwen</span>
          <span className="text-right font-semibold">€9,22</span>
          <span className="text-right text-[#c0392b] font-semibold">0</span>
        </div>
        <p className="text-muted text-[1.25vw] mt-[2vh]">
          Deze vijf termen samen €79,98 — nul conversies.
        </p>
      </div>
      ...
      <div className="absolute top-[31vh] right-[6vw] w-[33vw] bg-white rounded-[1vw] border border-[#e4e2ee] p-[2.4vw]">
        ...
        <p className="text-[1.35vw] text-muted leading-[1.45] mt-[2vh] text-pretty">
          In dit account leveren ‘carplay inbouwen’ en ‘apple carplay inbouwen’
          wél conversies; in het zusteraccount nul. De accounts beconcurreren
