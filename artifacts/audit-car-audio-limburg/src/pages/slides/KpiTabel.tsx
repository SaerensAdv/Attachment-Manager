  ...
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-bg text-text font-body">
      ...
      <p className="absolute bottom-[8.5vh] left-[6vw] right-[6vw] text-muted text-[1.15vw] text-pretty">
        De conversiemeting is begin 2026 strikter gezet: enkel een aankoop telt nog
        mee (in 2025 ook het contactformulier). Op vergelijkbare basis: aankopen 13
        → 1 — zie de volgende slide.
      </p>
