# Workflow: Content Production (SEO & Organic)

## Goal

Produce client-ready organic content — SEO blog articles, service/landing page copy, newsletters, social posts, or video scripts — that is genuinely helpful, on-brand, and built to rank, complementing (not duplicating) the client's paid search.

## When to use

A client needs new organic content: an SEO blog article or content series, copy for a new service/landing page, a newsletter, a content calendar, or social/video scripts. (For Google Ads search ad copy use `workflows/ad-copy.md`; for full paid-ad creative sets use `workflows/ad-creatives.md`.)
...
- Copywriter (lead — content & social specialty)
- SEO Specialist (search intent, topic mapping, on-page)
...
- The draft content (headline, body, CTA) — no invented facts or figures
- On-page elements (title, meta description, headings, internal links)
