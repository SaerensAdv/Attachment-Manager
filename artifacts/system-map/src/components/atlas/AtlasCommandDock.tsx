...
export default function AtlasCommandDock() {
  ...
  return <div className={`atlas-command-dock${generation.hasActiveFlow ? " has-flow" : ""}`}>
    <AnimatePresence>{generation.hasActiveFlow && <div className="atlas-generation-layer" key="atlas-generation-panel"><GenerationPanel gen={generation} /></div>}</AnimatePresence>
