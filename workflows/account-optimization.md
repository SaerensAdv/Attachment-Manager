...
3. **Trust the conversions first** (`knowledge/measurement-reporting.md`). If tracking looks broken or the conversions can't be trusted, stop and flag it — never optimize on numbers you can't trust.
